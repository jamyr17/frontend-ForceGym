      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-3 w-full">
        ...
        <div className="flex items-center gap-2 w-full">
          ...
          >
            ...
            {clientTypes.map((c) => (
              <option key={c.idClientType} value={c.idClientType}>
                {c.name}
              </option>
            ))}
          </select>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 w-full">
          ...
          <div className="flex flex-col w-full">
            ...
            <input
              ...
              className={`
                ...
                ${(filterByAmountRangeMin || filterByAmountRangeMax) ? "border-yellow text-yellow" : ""}
              `}
              value={filterByAmountRangeMin === 0 ? "" : filterByAmountRangeMin}
              min={0}
              onChange={(e) => {
                const val = e.target.value;
                if (val === "") return changeFilterByAmountRangeMin(0);
                if (+val < 0) return;
                changeFilterByAmountRangeMin(+val);
              }}
          ...
          <div className="flex flex-col w-full">
            ...
            <input
              ...
              onChange={(e) => {
                const val = e.target.value;
                if (val === "") return changeFilterByAmountRangeMax(0);
                if (+val < 0) return;
                changeFilterByAmountRangeMax(+val);
              }}
              style={{ MozAppearance: "textfield" }}
              onWheel={(e) => e.currentTarget.blur()}
            />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 w-full">
          ...
          <div className="flex flex-col w-full">
            ...
            <input
              ...
              className={`
                border rounded-md p-2 text-center w-full
                ${(filterByDateRangeMin || filterByDateRangeMax) ? "border-yellow text-yellow" : ""}
              `}
              value={
                filterByDateRangeMin
